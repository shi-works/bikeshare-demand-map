...
# CSVファイルを読み込む
df1 = pd.read_csv('./20230503/hellocycling_station_status.csv')
df2 = pd.read_csv('hellocycling_station.csv')
...
merged_df = merged_df.drop(
    columns=['vehicle_docks_available', 'vehicle_types_available'])

# 結果を新しいCSVファイルに出力する
merged_df.to_csv('./20230503/hellocycling_station_status_add_latlng.csv', index=False)
